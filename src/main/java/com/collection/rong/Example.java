...
import com.collection.rong.models.ChatroomInfo;
import com.collection.rong.models.FormatType;
import com.collection.rong.models.GroupInfo;
import com.collection.rong.models.ImgMessage;
import com.collection.rong.models.SdkHttpResult;
import com.collection.rong.models.TxtMessage;
import com.collection.rong.models.VoiceMessage;
import com.collection.rong.models.*;
/**
 * 一些api的调用示例
 */
public class Example {
	...
	public static void main(String[] args) throws Exception {
		...
		//餐饮大师应用
//		String key = "qd46yzrf44bkf";//替换成您的appkey
//		String secret = "mL9Oi4eIisJvQv";//替换成匹配上面key的secret
		String key = "kj7swf8o77ux2";//替换成您的appkey
		String secret = "Ye3gd38ghaM";//替换成匹配上面key的secret
